                                    ...
                                    <div className="shop-item-head-core">
                                        ...
                                        <div className="shop-items-data-core">
                                            ...
                                            <div className="shop-info-desc flex column">
                                                <p className="shop-text-desc">{contractHelper.setFormatUnit(value.price, 6) * this.state.buyNbr[key] } $CREST</p>
                                            ...
                                            (
                                                ...
                                                ?(
                                                    <button className="button glow-red-mobile shop-items-button flex row" onClick={() => this.buyBadges(key)}> 
                                                        <img className="shop-items-button-icon" src={cartIcon} alt={cartIcon} />
                                                        <p className="shop-items-button-text">{contractHelper.setFormatUnit(value.price, 6) * this.state.buyNbr[key]}$CREST</p>
                                                    </button>
