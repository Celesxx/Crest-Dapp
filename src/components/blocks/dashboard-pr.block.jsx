            ...
            <div className="home-body flex column">
                ...
                <div className="dashboard-button flex row">
                    <div className="dashboard-button-core flex row">
                        ...
                        <button onClick={() => this.props.history.push("/dashboard")} className="button-dash glow glow-red-mobile button-protocol flex row center">
                            { 
                        ...
                        <button onClick={() => this.props.history.push("/dashboard/personnal")} className="button-dash glow glow-blue-mobile button-personnal flex row center" id="currentDashboard">
                            { 
                                this.state.width <= 1200
